...
const projects = ref([
  {
    ...
    detailedDescription: 'Sistema avanzado que integra múltiples módulos de IA para optimizar la gestión de recursos empresariales en tiempo real.',
  ...
  },
  {
    ...
    detailedDescription: 'Bot conversacional con procesamiento de lenguaje natural que proporciona respuestas contextuales y personalizadas.',
  ...
  },
  {
    ...
    detailedDescription: 'Dashboard interactivo con modelos predictivos basados en datos históricos y análisis de series temporales.',
  ...
  },
  {
    ...
    detailedDescription: 'Modelo de visión por computadora entrenado con datasets personalizados para casos de uso específicos.',
  ...
  },
  {
    ...
    detailedDescription: 'Sistema integrado con LLMs para la generación automática de textos, código y documentación.',
  ...
  },
  {
    ...
    detailedDescription: 'Algoritmo de filtrado colaborativo híbrido que aprende de las preferencias del usuario en tiempo real.',
    ...
    <div class="max-w-[960px] mx-auto mt-10 md:mt-[90px] px-4 pb-20 relative z-10">
      ...
      >
        ...
        <div class="flex flex-wrap gap-6 mt-8">
          ...
          <div class="flex items-center gap-2">
            ...
            <span class="text-gray-300 text-sm">
              <span class="font-bold text-white">{{ projects.filter(p => p.status === 'Completado').length }}</span> Completados
            </span>
          </div>
        </div>
      </div>
      ...
      <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        >
          ...
          <div class="aspect-video w-full overflow-hidden relative">
            ...
            <div class="absolute inset-0 bg-gradient-to-br from-orange-500/20 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-500 z-10"></div>
          ...
          <div class="p-6 relative z-20">
            ...
            <!-- Title -->
            <h3 class="text-2xl font-bold text-white mb-3 group-hover:text-orange-400 transition-colors duration-300 leading-tight">
              {{ project.title }}
            </h3>
      ...
      >
        <div class="max-w-2xl mx-auto text-center">
          ...
          <button class="inline-flex items-center gap-2 px-6 py-3 bg-gradient-to-r from-orange-500 to-orange-600 hover:from-orange-600 hover:to-orange-700 text-white font-semibold rounded-full transition-all duration-300 transform hover:scale-105 hover:shadow-[0_0_30px_rgba(249,115,22,0.4)]">
